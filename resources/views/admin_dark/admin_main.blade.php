...
<head>
  <title>E-Jawlah : Admin Management System</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="content">
        <div class="container-fluid">
          <!-- your content here -->
          <h3 style="color:white" class="text-center">E-JAWLAH</h3>
          <h1 style="color:white" class="text-center py-4">Admin Management System</h1>
          <h4  style="color:red" class="text-center py-4"><i>Powered by Muhammad Irfan Nizar bin Anuar</i></h4>
          <h5 style="color:grey" class="text-center "><i>a.k.a Irfannizar</i></h5>
